...
test -e /root/puppet-enterprise && touch /root/puppet-enterprise/answers.txt && echo "You can now run the Puppet Enterprise installer with '-A answers.txt'"; cleanup 0;
